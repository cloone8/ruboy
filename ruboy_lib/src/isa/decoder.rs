...
const fn decode_prefixed(instr: u8) -> Result<Instruction, DecodeError> {
    let instr = match instr {
        ...
        0x02 => Instruction::RotLeftCarry(PrefArithTarget::Reg(Reg8::D)),
        0x03 => Instruction::RotLeftCarry(PrefArithTarget::Reg(Reg8::E)),
        0x04 => Instruction::RotLeftCarry(PrefArithTarget::Reg(Reg8::H)),
        0x05 => Instruction::RotLeftCarry(PrefArithTarget::Reg(Reg8::L)),
        0x06 => Instruction::RotLeftCarry(PrefArithTarget::MemHL),
        0x07 => Instruction::RotLeftCarry(PrefArithTarget::Reg(Reg8::A)),
        0x08 => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::B)),
        0x09 => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::C)),
        0x0A => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::D)),
        0x0B => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::E)),
        0x0C => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::H)),
        0x0D => Instruction::RotRightCarry(PrefArithTarget::Reg(Reg8::L)),
